...
function reconstruct_points(
    ...
    if loss_weights_refine == (1.,)
        ...
        steps = (DINCAE_mod.recmodel4(sz[1:2],enc_nfilter,dec_nfilter,skipconnections; method = upsampling_method),
                 DINCAE_mod.recmodel4(sz[1:2],enc_nfilter2,dec_nfilter2,skipconnections; method = upsampling_method))
    end
    model = StepModel(
