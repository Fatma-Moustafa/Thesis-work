...
function plotvec(cases,fnameavg,varnames;
    ...
    function plotrad(hfsite,r,cl)
        ...
        DINCAE_utils_mod.set_aspect_ratio()
    ...
    for n = time_index
        ...
        for k = 1:length(cases)
            ...
            direction_obs = DINCAE_utils_mod.dirobs(lon,lat,hfsite.lon,hfsite.lat,hfsite.positive_toward)
            ur,sigma_ur = DINCAE_mod.vector2_projection((u,v),(P11,P12,P22),direction_obs)
