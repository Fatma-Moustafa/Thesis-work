...
Pkg.add(["CUDA","NCDatasets","PyPlot", "PyCall", "ChainRulesCore", "ThreadsX", "Flux","Distributions","GeoDatasets", "Glob", "JSON", "LinearAlgebra", "Interpolations"])
...
fname = joinpath(localdir,"cmems_obs-oc_med_bgc-plankton_my_l3-multi-1km_P1D_1693840835803.nc")
# filename of the data with added clouds for cross-validation
fname_cv = joinpath(localdir,"cmems_obs-oc_med_bgc-plankton_my_l3-multi-1km_P1D_1693840835803_add_clouds.nc")
varname = "CHL"

auxdata_files = [
  (filename = joinpath(localdir,"cmems_obs-sst_med_phy_my_l3s_P1D-m_1693479212270.nc"),
