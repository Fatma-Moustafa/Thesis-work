...
Pkg.add(["CUDA","Knet","NCDatasets","PyPlot","Plots", "PyCall", "ChainRulesCore", "ThreadsX", "Flux","Distributions","GeoDatasets", "Glob", "JSON", "LinearAlgebra", "Interpolations"])
...
fname = joinpath(localdir,"cmems_obs-sst_med_phy_my_l3s_P1D-m_1693479212270.nc")
# filename of the data with added clouds for cross-validation
fname_cv = joinpath(localdir,"cmems_obs-sst_med_phy_my_l3s_P1D-m_1693479212270_add_clouds.nc")
